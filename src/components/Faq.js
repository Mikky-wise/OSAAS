...
export default function Faq() {
    ...
    return (
        <div
            class="bg-gradient-to-b from-gray-50 to-white lg:mb-16 xl:mb-24 py-12 lg:pt-20 relative overflow-hidden">
            <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 relative z-20">
                <div class="text-center mb-6 md:mb-8 lg:mb-12">
                    <h2
                        class="text-gray-800 text-3xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4">FAQ</h2>
                    ...
                    <ul class="divide-y divide-gray-300text-base md:text-lg">
                        ...
                        <li>
                            <button
                                class="py-3 lg:py-4 font-bold focus:outline-none hover:text-indigo-700 w-full flex items-center justify-between">
                                <span class="flex-1 text-left pr-6">
                                    If you could change one thing about the advert you’ve just seen/heard, what
                                    would it be?
                                </span>
                                <svg
                                    class="w-6 h-6 text-indigo-600"
