...
export default function AgentsAddModal(props) {
        ...
        <div className="relative w-auto my-6 max-w-6xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="w-full md:w-1/2 px-2 hidden md:block">
                <img src="./addagents.svg" alt="Delivery Solution for Businesses" />
              </div>
              ...
              <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  <div class="mb-6">
                    ...
                    <input class="shadow appearance-none  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="contact" type="number" placeholder="Contact" />
